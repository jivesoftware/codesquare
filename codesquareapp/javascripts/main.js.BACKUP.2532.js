															...
															osapi.people.getViewer().execute(function (viewerData){
																										if(!viewerData.error){
																											...
																											var params2 = {"activity": {"title": message,
																												...
																												osapi.activities.create(activity).execute(diivCallback(message));
																												osapi.activities.create(params).execute(streamPostCallback(message));
...
function streamPostCallback(message){
	...
	alert("You posted to their Activity Stream! They will receive a notification of this.");
};
...
>>>>>>> a8d1461ba19c4a4b5ac35b385d1dd9d413355edd
