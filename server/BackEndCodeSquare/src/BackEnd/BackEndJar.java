...
public class BackEndJar {
     ...
     * 
     * @param filename the name of the file containing all the commits
     */
    ...
    public static ArrayList<Commit> parseGitInput(String filename) {
        ...
        for (JSONObject j : jObs) {
            try {
                ...
                Logger.getLogger(BackEndJar.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String[] args) {
        if (args.length != 1) {
            System.err.println("This jar should take exactly 1 argument which should be a String");
        } else {
