...
/**
 * Badge class used to store the badge info needed for activity stream post. The
 * badgesList being passed into the makeJsonPost() function should be a list of
 * these objects. Definitely import this class.
 * 
 * @author eric.ren
 * 
 */
