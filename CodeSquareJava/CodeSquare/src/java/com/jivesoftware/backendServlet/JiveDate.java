...
public class JiveDate {
    ...
    /**
     * add date to Commit - parses unixtimestamp to be used for push time
     * 
     * @param dateString
     *            A String containing unixtimestamp
     * @param timeZone
     *            A String cointaining timezone // isoTime is in ISO 8601 Format
     *            // global = GMT-7 (aka PDT) local date is PDT global date is
     *            wherever they are
     */
    // only for commitDate!
    ...
    public String localToString() {
        return (localDate.getTime().getTime() / 1000) + " "
    ...
    public String globalToString() {
        return (globalDate.getTime().getTime() / 1000) + " "
                + globalDate.getTimeZone();
    }
}