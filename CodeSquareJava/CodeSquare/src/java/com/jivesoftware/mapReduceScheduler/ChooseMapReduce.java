...
public class ChooseMapReduce {
    ...
    /***
     * checks the current hour and day to determine which map reduce to run
     * @param day
     * @return
     * @throws Exception 
     */
    ...
    /**
     * takes a date, uses the field to change and the offset to change the month day or year
     * @param dateString
     * @param fieldToChange
     * @param offset
     * @return
